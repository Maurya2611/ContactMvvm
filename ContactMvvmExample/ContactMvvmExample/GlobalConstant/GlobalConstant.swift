...
struct Paths {
    ...
    static let contact  = "/contacts/\(URLParameters.contactId).json" //GET, PUT & DELETE
}
struct Keys {
...
struct Images {
    ...
    static let favoritebutton          = UIImage(named: "favourite_button")
    static let favoritebuttonselected = UIImage(named: "favourite_button_selected")
    static let placeholderphoto        = UIImage(named: "placeholder_photo")
}
